...
import classes from "./CreateUpdateDoctor.module.css";
import { Link, withRouter } from "react-router-dom";

class CreateUpdateDoctor extends Component {
  state = {
    firstName: "",
    lastName: "",
    jmbg: "",
...
export default withRouter(CreateUpdateDoctor);
